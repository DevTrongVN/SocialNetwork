...
async function register() {
    ...
    if (!username || !email || !password || !confirmPass) { showError("Vui lòng điền đủ thông tin!"); return; }
    if (password !== confirmPass) { showError("Mật khẩu xác nhận không khớp!"); return; }
